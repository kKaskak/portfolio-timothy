/*! For license information please see 726.77cdd497.chunk.js.LICENSE.txt */
(self.webpackChunkforntend_react = self.webpackChunkforntend_react || []).push([
	[726],
	{
		899: function (e, t) {
			var n, o, r;
			!(function (i) {
				...
				(void 0 != y &&
					...
					(function () {
						try {
							return (
								'test' ===
								new y().decode(new g().encode('test'), {
									stream: !0,
								})
							);
						} catch (e) {
				...
				(T.prototype.open = function (e, t) {
					...
					this._abort = function (e) {
						0 !== n._sendTimeout &&
							(s(n._sendTimeout), (n._sendTimeout = 0)),
							(1 !== r && 2 !== r && 3 !== r) ||
								((r = 4),
								(o.onload = C),
								(o.onerror = C),
					...
					'onload' in o &&
						...
						(!('contentType' in o) && 'ontimeout' in d.prototype) ||
							(t +=
								(-1 === t.indexOf('?') ? '?' : '&') +
								'padding=true'),
						o.open(e, t, !0),
					...
					(T.prototype.send = function () {
						if (
							('ontimeout' in d.prototype &&
								('sendAsBinary' in d.prototype ||
									'mozAnon' in d.prototype)) ||
							void 0 == l ||
							void 0 == l.readyState ||
					...
					R.call(this),
						...
						(function (e, t, n) {
							...
							var o = Boolean(n.withCredentials),
								r =
									n.lastEventIdQueryParameterName ||
									'lastEventId',
								i = z(1e3),
				...
				var $ = h;
				void 0 == d ||
					(void 0 != h && 'withCredentials' in h.prototype) ||
					($ = Q),
					(function (i) {
						...
						(e.EventSourcePolyfill = Q),
							(e.NativeEventSource = h),
							(e.EventSource = $);
					});
			})(
		...
		726: (e, t, n) => {
			e.exports = n(899).EventSourcePolyfill;
		},
	},
]);
//# sourceMappingURL=726.77cdd497.chunk.js.map
